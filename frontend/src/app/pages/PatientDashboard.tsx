...
export default function PatientDashboard() {
  ...
  const HealthTips = [
    "Stay hydrated! Drinking adequate water prevents infections and improves sleep.",
    "A 30-minute walk every day can significantly improve your cardiovascular health.",
    "Ensure at least 7-8 hours of quality sleep to boost your immune system.",
    "Include more green leafy vegetables in your diet for essential vitamins and minerals.",
    "Practice mindfulness or meditation for 10 minutes to reduce stress levels.",
    "Avoid prolonged sitting—take a 5-minute break every hour to stretch."
  ];

  useEffect(() => {
    // Randomize health tip
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          ...
          <Card className="p-6 hover:shadow-lg transition-shadow border-0 shadow-md">
            ...
            <h3 className="text-xl font-semibold mb-2">Health Record</h3>
